                                    ...
                                    <div class="front" title="${
                                      e.estado_accion
                                        ...
                                        <div class="content">
                                            ...
                                            <div id=${
                                              e.cod_mesa
                                            } class="footer" style="cursor:pointer" onclick=${() =>
                    RotarCard(e.Nro_Cuentas, e.cod_mesa)}>
                                                Ver Detalles                                
                                            </div>
                                        </div>
                                    </div> 
                                        ...
                                        <div class="content">
                                            <div class="main">
                                                <div class="row" style="display:none">
                                                    <div class="col m12">
                                                        <a class="waves-effect yellow black-text btn btn-small btn-block" style="font-size: 12px;width: 100%;padding: 0 0.5rem;" onclick=${() =>
                                                          VerDetalles(
                                                            e,
                                                            "C"
                                                          )}><i class="material-icons left">receipt</i> Comprobante</a>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col m12">
                                                        <a class="waves-effect yellow black-text btn btn-small btn-block" style="font-size: 12px;width: 100%;padding: 0 0.5rem;" onclick=${() =>
                                                          VerDetalles(
                                                            e,
                                                            "I"
                                                          )}><i class="material-icons left">print</i> Imprimir voucher</a>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col m12">
                                                        <a class="waves-effect  yellow black-text btn btn-small btn-block" style="font-size: 12px;width: 100%;padding: 0 0.5rem;" onclick=${() =>
                                                          VerDetalles(
                                                            e,
                                                            "D"
                                                          )}><i class="material-icons left">format_list_bulleted</i> Detalles</a>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col m12">
                                                        <a class="waves-effect yellow black-text btn btn-small btn-block" style="font-size: 12px;width: 100%;padding: 0 0.5rem;" onclick=${() =>
                                                          VerDetalles(
                                                            e,
                                                            "T"
                                                          )}><i class="material-icons left">check_circle</i> Terminar cuenta</a>
                                                    </div>
                                                </div>
                                            </div>
  ...
  var el = yo`
    <div class="card">
        <div class="card-content">
            <span class="card-title center">Detalle de la cuenta ${i} - ${
    punto_venta.nombre_mesa
  }</span> 
            <div class="row">
                <div class="col m6">
                    <div id="stacked-cards-block" class="stackedcards stackedcards--animatable init">
                        ...
                        ${productos.map((p, index, array) =>
                          array[index + 1] != undefined
                            ? p.id_referencia == "0" &&
                              array[index + 1].id_referencia == "0"
                              ? yo`
                                <div class="card" id="${
                                  p.id_detalle + "-" + p.pedido_id
                                }">
                                    <div class="card-image">
                                        ...
                                        <a class="col m5 s5 offset-s6 btn-floating btn-small halfway-fab waves-effect waves-light red" style="left: 24px;border-radius: 0%;width: auto;padding-left: 10px;padding-right: 10px;" onclick=${() =>
                                          RechazarProducto(
                                            p,
                                            cuenta
                                          )}>Eliminar</a>
                                        <a class="btn-floating btn-large halfway-fab waves-effect waves-light green" style="display:none" onclick=${() =>
                                          AceptarProducto(
                                            p,
                                            cuenta
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="row center">
                                            <div class="col m4 s4">
                                                <a href="javascript:void(0);" class="waves-effect waves-light red-text" onclick="${() =>
                                                  DisminuirCantidad(
                                                    index
                                            ...
                                            <div class="col m4 s4">
                                                <input value="${
                                                  p.cantidad
                                                }" id="${index}" type="number" class="validate" style="text-align: -webkit-center;text-align: center;font-size: 45px;font-style: oblique;font-weight: bold;" onkeyup=${() =>
                                  CambioCantidad(index)}  onchange=${() =>
                                  CambioCantidad(index)}> 
                                            </div>
                                            <div class="col m4 s4">
                                                <a href="javascript:void(0);" class="waves-effect waves-light blue-text" onclick="${() =>
                                                  AumentarCantidad(
                                                    index
                                  ...
                                  ? yo`
                                    <li>  
                                        <div class="collapsible-header" style="display: table;width: 100%;"> 
                                            <a href="javascript:void();" class="collection-item right-align right col s12 col m12" onclick=${() =>
                                              SeleccionarProducto(
                                                p,
                                                productos,
                                                cuenta
                                      ...
                                      p.descripcion_detalle
                                    }</span> <span class="new badge green right-align" data-badge-caption="${
                                      productos[0].cod_moneda == "PEN"
                                        ? "S/ "
                                        : "USD"
                                    } ${(
                        ...
                        <div class="collapsible-header" style="display: table;width: 100%;"> 
                            <a href="javascript:void();" class="collection-item right-align right col s12 col m12" onclick=${() =>
                              SeleccionarProducto(
                                ...
                                productos,
                                cuenta
                              )}><span class="left">(${p.cantidad}) ${
                      p.descripcion_detalle
                    }</span> <span class="new badge green right-align" data-badge-caption="${
                      productos[0].cod_moneda == "PEN" ? "S/ " : "USD"
                    } ${(parseFloat(p.cantidad) * parseFloat(p.precio)).toFixed(
                      2
                    )}"></span></a>
                        </div>
                    </li>`
            ...
            <li>
                <div class="collapsible-header" style="display: table;width: 100%;"> 
                    <a href="javascript:void();" class="collection-item right-align right">
                        Total : ${
                          productos[0].cod_moneda == "PEN" ? "S/ " : "USD"
                        } ${parseFloat(productos[0].total).toFixed(2)}
                    </a>  
                </div>
            </li>
        </ul>`;
            ...
            <div class="modal-content">
                ...
                <div class="row">
                    <div class="collection">
                        ${cuentas.map(
                          (e, i) => yo` 
                            <a href="javascript:void(0);" class="collection-item" onclick=${() =>
                              SeleccionarCuenta(
                                e,
                                tipo,
                                i + 1,
                                punto_venta
                              )}><i class="material-icons left">label_outline</i> CUENTA : ${
                            i + 1
                          }</a>
                        `
                        )}
...
function VerInvoice(pedido_detalle) {
  ...
  var el = yo` 
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        <input style="text-transform: uppercase;"  id="numero_doc" type="text" class="validate" value="${
                                          pedido_detalle[0].doc_ident != null
                                            ? pedido_detalle[0].doc_ident
                                            : ""
                                        }">
                                ...
                                <div class="row" id="divRazonSocial" style="display:none">
                                    <div class="input-field col s12">
                                        <input style="text-transform: uppercase;" id="razon_social" type="text" class="validate" data-length="120" value="${
                                          pedido_detalle[0].razon_social != null
                                            ? pedido_detalle[0].razon_social
                                            : ""
                                        }">
                                    ...
                                    <div class="input-field col s12">
                                        <div class="row">
                                            <input style="text-transform: uppercase;" id="nombres" type="text" class="validate" data-length="40" value="${
                                              pedido_detalle[0].nombres != null
                                                ? pedido_detalle[0].nombres
                                                : ""
                                            }">
                                ...
                                <div class="row" id="divApellidos">
                                    <div class="input-field col s6">
                                        <input style="text-transform: uppercase;" id="a_paterno" type="text" class="validate" data-length="30" value="${
                                          pedido_detalle[0].a_paterno != null
                                            ? pedido_detalle[0].a_paterno
                                            : ""
                                        }">
                                    ...
                                    <div class="input-field col s6">
                                        <input style="text-transform: uppercase;" id="a_materno" type="text" class="validate" data-length="30" value="${
                                          pedido_detalle[0].a_materno != null
                                            ? pedido_detalle[0].a_materno
                                            : ""
                                        }">
                            ...
                            ${pedido_detalle.map(
                              (e) => yo` 
                                <tr id="${idFila}-${e.producto_id}">
                                    <td class="Detalle"><p style="display:none" class="pDetalle pValor">${
                                      e.descripcion_detalle
                                    }</p> <input style="text-transform: uppercase;" type="text" class="validate" value="${
                                e.descripcion_detalle
                              }" disabled></td>
                                    <td class="Cantidad"><p style="display:none" class="pCantidad pValor">${parseFloat(
                                      e.cantidad
                                    ).toFixed(
                                      2
                                    )}</p><input style="text-transform: uppercase;text-align: right;" type="number" class="validate" value="${parseFloat(
                                e.cantidad
                              ).toFixed(2)}" onkeyup="${() =>
                                CambioCelda(
                                  pedido_detalle[0].cod_moneda == "PEN"
                                    ? "S/ "
                                    : "USD ",
                                  idFila + "-" + e.producto_id
                                )}"></td>
                                    <td class="Precio"><p style="display:none" class="pPrecio pValor">${
                                      e.precio
                                    }</p><input style="text-transform: uppercase;text-align: right;" type="number" class="validate" value="${
                                e.precio
                              }" onkeyup="${() =>
                                CambioCelda(
                                  pedido_detalle[0].cod_moneda == "PEN"
                                  ...
                                  idFila + "-" + e.producto_id
                                    ...
                                    <td class="Total"><p style="display:none" class="pTotal pValor">${(
                                      parseFloat(e.cantidad) *
                                      parseFloat(e.precio)
                                    ).toFixed(
                                      2
                                    )}</p><input style="text-transform: uppercase;text-align: right;" type="number" class="validate" value="${(
    ...
    pedido_detalle[0].total
  ).toFixed(2)}</strong>
                                    </p>
                                    <p>
                                    <strong id="Descuento" contenteditable="true" onkeyup="${() =>
                                      CambioDescuento(
                                        pedido_detalle[0].cod_moneda == "PEN"
                                          ? "S/ "
                                          : "USD "
                                      )}">${
    pedido_detalle[0].descuento == "" ||
    pedido_detalle[0].descuento == null ||
    empty(pedido_detalle[0].descuento)
      ? "0"
      : pedido_detalle[0].descuento
  }</strong>
                                    </p>
                            ...
                            <tr>
                                ...
                                <td class="center"><h5><strong id="totalGlobal">${
                                  pedido_detalle[0].cod_moneda == "PEN"
                                    ? "S/ "
                                    : "USD "
                                }${parseFloat(pedido_detalle[0].total).toFixed(
    2
  )}</strong></h5></td>
                            </tr>
                        </tbody>
                    </table>
                    <a class="waves-effect grey darken-4 btn" onclick=${() =>
                      AceptarPedido(
                        pedido_detalle
                      )}><i class="material-icons left">print</i>Aceptar</a>
                </div>
            </div>
        </div>`;
  var container = document.getElementById("contenido_principal");
  ...
  var sub_nav = yo`
    <div class="collection">
        <a href="#!" class="collection-item" onclick=${() => inicio()}>Atras</a>
        <a href="#!" class="collection-item" onclick=${() =>
          comprobantes()}>Todos los comprobantes</a>
        <a href="#!" class="collection-item" onclick=${() =>
          nuevoComprobante()}>Nuevo Comprobante</a>
    </div>`;
  var container = document.getElementById("sub_navegador_content");
  empty(container).appendChild(sub_nav);
...
function LlenarCombinaciones(producto, tipo, productos, index) {
  if (tipo == "card")
    return yo`<ul class="collection">
                    ${productos.map((p) =>
                      producto.id_detalle == p.id_referencia &&
                      p.id_referencia != "0"
                        ? yo`
                        <li class="collection-item">(${p.cantidad}) ${
                            p.nombre != "" && p.nombre != null
                              ? p.nombre
                              : p.descripcion_detalle
                          }</li>`
                        : yo``
    ...
    return yo`
            <div class="collection right-align">
                ${productos.map((p) =>
                  ...
                  p.id_referencia != "0"
                    ? yo`
                    <a href="javascript:void();" style="color: #2c2c54;font-size: 12px;font-weight: bold;" class="collection-item">(${
                      p.cantidad
                    }) ${
                        p.nombre != "" && p.nombre != null
                          ? p.nombre
                          : p.descripcion_detalle
                      } <span class="new badge orange right-align" data-badge-caption="${
                        productos[0].cod_moneda == "PEN" ? "S/ " : "USD"
                      } ${(
...
function LlenarTipoDocumentos(documentos) {
  var el = yo`
        ...
        ${documentos.map(
          (e) => yo`
             <option value="${e.cod_documento}" onchange=${() =>
            TraerSeriesNumeros(e.cod_documento)}>${e.descripcion_doc}</option>
        `
        )}
        </select>`;
...
function SeleccionarProducto(p, productos, cuenta) {
  var idPadre = $(".stackedcards-container")
    .find(".stackedcards-active")
    .attr("id");
  ...
  var contentCard = yo`
        ...
        ${productos.map((p_, index) =>
          p_.id_detalle == p.id_detalle && p_.pedido_id == p.pedido_id
            ? yo`
            <div>
                <div class="card-image">
                    <img  src="public/images/${
                    ...
                    <a class="col m5 s5 offset-s6 btn-floating btn-small halfway-fab waves-effect waves-light red" style="left: 24px;border-radius: 0%;width: auto;padding-left: 10px;padding-right: 10px;" onclick=${() =>
                      RechazarProducto(p_, cuenta)}>Eliminar</a>
                    <a class="btn-floating btn-large halfway-fab waves-effect waves-light green" style="display:none"  onclick=${() =>
                      AceptarProducto(
                        p_,
                        cuenta
                ...
                CambioCantidad(index)} onchange=${() => CambioCantidad(index)}> 
                        </div>
                        <div class="col m4 s4">
                            <a href="javascript:void(0);" class="waves-effect waves-light blue-text" onclick="${() =>
                              AumentarCantidad(
  ...
  var contentPadre = yo`
        <div>
        ${productos.map((p_, index) =>
          p_.id_detalle == id_detalle_padre && p_.pedido_id == pedido_id_padre
            ? yo`
            <div>
                <div class="card-image">
                    <img  src="public/images/${
...
function CambioCelda(moneda, idTR) {
  ...
  $("#" + idTR)
    .find("td.Total")
    .find("input")
    .val((parseFloat(Cantidad) * parseFloat(Precio)).toFixed(2));
  ...
  $("#" + idTR)
    .find("td.Total")
    .find("p.pTotal")
    .text((parseFloat(Cantidad) * parseFloat(Precio)).toFixed(2));
...
function ConfirmarCantidad(e, cuenta, idCantidad) {
  ...
  if (r == true) {
    fetchActualizarCantidadDetallePedido(
      e.pedido_id,
      e.id_detalle,
      parseInt(cantidad),
      function (res) {
...
function CambioDescuento(moneda) {
  ...
  var total =
    (parseFloat(
      $("#SumaTotal").text().trim().replace("S/", "").replace("USD", "")
    ) *
...
function AceptarPedido(pedido_detalle) {
  ...
  var numero = parseInt(
    $("#numero").val().trim() == "" ? "0" : $("#numero").val().trim()
  );
...
function fetchActualizarCantidadDetallePedido(
  pedido_id,
  id_detalle,
  cantidad,
  callback
...
function generateInvoice() {
  ...
  doc.roundedRect(
    startX - 10,
    startY + lineSpacing.MarginSeccionCliente - 20,
    520,
    80,
    3,
    3
  ...
  doc.textAlign(
    ...
    { align: "left" },
    startX,
    (startY += lineSpacing.MarginSeccionCliente)
  );
  doc.setFontType("normal");
  // var w = doc.getStringUnitWidth('GSTIN') * NormalFontSize;
  doc.textAlign(
    $("#tipo_doc_ident").val() == "DNI"
      ? $("#nombres").val() +
          " " +
          $("#a_paterno").val() +
          " " +
  ...
  doc.textAlign(
    "R.U.C. " + companyJSON.CompanyRUC,
    { align: "left" },
    rightStartCol1 + 30,
    (tempY += lineSpacing.MarginTop)
  );
  doc.setFont("helvetica");
  doc.setFontType("bold");
  doc.setFontSize(fontSizes.TitleFontSize);
  doc.textAlign(
    $("#cod_documento option:selected").text(),
    { align: "left" },
    rightStartCol1 + 10,
  ...
  var resd = doc.autoTableHtmlToJson(
    document.getElementById("tablaComprobante")
  );
