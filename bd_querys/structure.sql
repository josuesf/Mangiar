...
CREATE TABLE ecaja.divisa --Josue
( 
cod_divisa           varchar(4)  NOT NULL ,
nombre_divisa        varchar(80)  NULL ,
...
CREATE TABLE ecaja.divisa_denominacion --Josue
( 
cod_divisa           varchar(4)  NOT NULL ,
id_denominacion      integer  NOT NULL ,
denominacion         varchar(25)  NULL ,
valor_divisa         numeric(9,4) ,
estado      varchar(20) default 'ACTIVO',
creado_en TIMESTAMP NOT NULL,
usuario_creacion varchar(50),
actualizado_en TIMESTAMP,
usuario_actualizo varchar(50),
 PRIMARY KEY (cod_divisa,id_denominacion),
 FOREIGN KEY (cod_divisa) REFERENCES ecaja.divisa(cod_divisa)
);